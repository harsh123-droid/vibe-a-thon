  ...
  strip.addEventListener("wheel", (e) => {
    if (e.deltaY !== 0) {
      ...
      if ((isAtLeft && e.deltaY < 0) || (isAtRight && e.deltaY > 0)) {
        // At boundaries, allow normal vertical page scroll
        return;
      }

      e.preventDefault();
      
      // Disable CSS scroll snapping dynamically while mouse wheeling
      strip.style.scrollSnapType = "none";
      strip.scrollLeft += e.deltaY;

      // Restore it shortly after wheeling stops so it snaps nicely into place
